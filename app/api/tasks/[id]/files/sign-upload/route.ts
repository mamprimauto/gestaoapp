...
// Limites atualizados para corresponder aos componentes
const MAX_DEFAULT = 1024 * 1024 * 1024 // 1GB
const MAX_AVATAR = 100 * 1024 * 1024 // 100MB (atualizado)
const MAX_INSPIRATION = 900 * 1024 * 1024 // 900MB (atualizado)
const MAX_ENTREGAVEL = 2 * 1024 * 1024 * 1024 // 2GB (novo)
