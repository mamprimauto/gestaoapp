-- Migration: AB Test Options Configuration System
-- Allows editing/adding/deleting test types and channels

-- Table to store configurable options
...
-- Final verification
SELECT 'ab_test_options table created successfully!' as result;
SELECT COUNT(*) as total_options FROM ab_test_options;