-- ========================================
-- SISTEMA COMPLETO DE TRACK RECORD (CORRIGIDO)
-- ========================================
...
-- Políticas para track_record_assignments (CORRIGIDAS)
...
-- Políticas para track_record_results (CORRIGIDAS)
...
-- Políticas para outras tabelas (CORRIGIDAS)
