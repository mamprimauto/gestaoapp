-- ========================================
-- SOLUÇÃO DEFINITIVA: Corrigir TUDO relacionado a organizações
...
-- PASSO 5: Garantir que o usuário específico tem organização
-- (Substitua o ID se necessário, mas o script acima já deve ter criado)
DO $$
DECLARE
    org_id UUID;
    user_id UUID := 'f3f3ebbe-b466-4afd-afef-0339ab05bc22';
BEGIN
...
-- ========================================
-- TESTE RÁPIDO - Simular uma query que o app faz
-- ========================================
SELECT 
    om.organization_id,
    o.id,
...
-- ========================================
-- SE AINDA DER ERRO 500, EXECUTE ISTO:
-- ========================================
