...
CREATE TABLE IF NOT EXISTS track_records (
  ...
  -- Unique constraint para o ID do track record por organização
...
CREATE TABLE IF NOT EXISTS track_record_variations (
  ...
  -- Uma variação por nome por teste
...
-- ========================================
CREATE INDEX idx_track_records_organization ON track_records(organization_id);
CREATE INDEX idx_track_records_type ON track_records(test_type);
CREATE INDEX idx_track_records_status ON track_records(status);
CREATE INDEX idx_track_records_date ON track_records(start_date);
CREATE INDEX idx_track_records_channel ON track_records(channel);
CREATE INDEX idx_track_record_variations_test ON track_record_variations(track_record_id);
CREATE INDEX idx_track_record_kpis_variation ON track_record_kpis(variation_id);
CREATE INDEX idx_track_record_kpis_name ON track_record_kpis(kpi_name);
...
-- Membros da organização podem ver track records
...
-- Membros podem criar track records
...
-- Membros podem atualizar track records
