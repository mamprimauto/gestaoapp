-- ========================================
-- SIMPLIFICAR SISTEMA DE TRACK RECORDS (COM LIMPEZA DE DUPLICADOS)
-- Remove organizações, limpa dados duplicados e todas as dependências
-- ========================================
...
-- Primeiro, vamos identificar e manter apenas o registro mais recente de cada track_record_id
DO $$
DECLARE
...
-- PASSO 8: Atualizar função para gerar IDs sem organization_id
